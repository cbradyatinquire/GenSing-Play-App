...
void interceptInputFromPopUp() {
  if( inputFromPopUp.equals( "" ) == false ) { // see index.html
...
class WaveActivity extends LVActivity {
  ...
  void openPopUpInput() {
  // gotta reworkk this method for JS
...
} // end class CodeItem// Wave Activity's User Interface Class (Extends Class ActivityUI )
  ...
  //@Override
    ...
    if ( mouseButton == LEFT ) {     
      ...
      if( whichOne == 0 ) { // "Choose Code(s)"
        //PopUpTest popUpTest = new PopUpTest( owner, 400, 300 );
        //owner.activePopUp = popUpTest;
        //owner.activePopUp.display();
